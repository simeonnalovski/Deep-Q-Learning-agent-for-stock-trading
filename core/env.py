...
# sospstvena serdina za nasite signali
class Env(TradingEnv):
    ...
    # maksimalen profit, pri idealno trguvanje
    def max_possible_profit(self):
        ...
        return profit
    # skaliranje na momentaliot prozorec
    def _get_observation(self):
        current_window = self.signal_features[(self._current_tick - self.window_size)
                                              :self._current_tick]
        return standard_scale(current_window)

    # dodeluvanje na nagrada pri pravilna prognoza za sleden den
    ...
    # profit se azurira pri trguvanje (kupuvanje ili prodavanje)
